...
def get_colors_for_classes(num_classes):
    ...
    if (hasattr(get_colors_for_classes, "colors")
...
def draw_boxes(image, boxes, box_classes, class_names, scores=None):
    ...
    font = ImageFont.FreeTypeFont(font='font/FiraMono-Medium.otf',
    ...
    for i, c in list(enumerate(box_classes)):
        ...
        label_bbox = draw.textbbox((left, top), label, font)
        label_size = (label_bbox[2] - label_bbox[0],
